            ...
            <!-- mapa ubicación -->
                <div class="row">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <span class="fa fa-fw fa-calendar-o"></span> Eventos
                        </li>
                    </ol>
                </div>
            <!-- /mapa ubicación -->
                ...
                <fieldset>
                    <legend><h2>Observaciones</h2></legend>
                    <div class="wrapper-form-md">
                        <div class="col-md-4 col-sm-12">
                            <input type="number" class="form-control" placeholder="Encargado" name="iEncargado">
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Unidad" name="iUnidad">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Montan" name="iMontan">
                            </div>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" rows="4" placeholder="Observaciones de la nota"></textarea>
                        </div>
                    </div>
                </fieldset>
            </div>
