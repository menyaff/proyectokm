...
INSERT INTO `modulos` VALUES (1,'Administrar','localhost/admin?visitante=ok',NULL,'0'),(2,'Servicios','localhost/servicios',NULL,'0');
...
INSERT INTO `usuarios` VALUES (1,'admin','c2c23c37fda1d113e9fe3de820bbd36a5c0be5d6','1e94dc565e37ea8edc3ab5495c070ebd21d48942',0,0),(6,'Erika','67ac4036e9ab38a3d5cdbc47be1512a54a900476','9ef8c14441ca95659efe7bb4ba2b0267859172cf',8,2),(8,'MenyAFF','4292ed22e78977eebcb78bfdabfe590ec7ad7e2d','f82f7c28fc5c9e325ae54366ea9ecb1c7794d3cd',1,2);
...
BEGIN
    ...
    SELECT 'TRUE' AS respuesta, 'Registros insertados correctamente' AS mensaje;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SET @sqlQuery = "SELECT rm.id AS id_rolModulo, m.id AS id_modulo, m.nombre AS modulo, r.id AS id_rol, r.nombre AS rol, m.url, m.prioridad
...
ThisSP:BEGIN
	IF(P_id IS NULL OR P_id=0) THEN
		INSERT INTO clientes VALUES (0,P_clave,P_nombre,P_nombreContacto,P_nombre2Contacto,P_nombreEmpresaContacto,P_telefonoContacto,P_celularContacto,P_emailContacto,P_webContacto,P_rfcFiscal,P_nombreComercialFiscal,P_calleFiscal,P_coloniaFiscal,P_ciudadFiscal,P_codigoPostalFiscal);
...
-- Dump completed on 2016-06-26  1:04:25
