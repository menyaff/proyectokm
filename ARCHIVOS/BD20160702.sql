...
INSERT INTO `modulos` VALUES (1,'Inicio','index.php','home','0','1'),(2,'Cat&aacute;logos',NULL,'book','0','3'),(3,'&Aacute;reas','areas.php',NULL,'2','1'),(4,'Familias','familias.php',NULL,'2','2'),(5,'Subfamilias','subfamilias.php',NULL,'2','3'),(6,'Bancos','bancos.php',NULL,'2','4'),(7,'Cuentas bancarias','cuentasBancarias.php','university','0','2');
...
INSERT INTO `rolesmodulos` VALUES (1,1,1),(2,2,1),(3,1,2),(4,1,3),(5,1,4),(6,1,5),(7,2,2),(8,2,3),(9,2,4),(10,2,5),(11,1,6),(12,1,7),(13,2,6);
...
BEGIN
	SET @sqlQuery = "SELECT rm.id AS id_rolModulo, m.id AS id_modulo, m.nombre AS modulo, r.id AS id_rol, r.nombre AS rol, m.url, m.claseAwesome, m.prioridad
