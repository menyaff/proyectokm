...
INSERT INTO `cat_puestos` VALUES (1,'CEO');
...
INSERT INTO `usuarios` VALUES (1,'admin','94ff4f0278511cfa5aeb89294e46a49b6dc00ebc','592a33e59052384071b151a7fc09ea03ef82ce7d',0,0),(6,'Erika','4ab4deac881b05c4c3342022cd84d3cf537a7112','1a2b3c4d',8,2),(8,'MenyAFF','fb0a8929865016ba27349dbfeeaa31a699fb74d5','abcdEF01',1,2);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPQ_cat_ciudades`(IN P_estado INT)
BEGIN
	IF(P_estado IS NULL) THEN
		SELECT * FROM cat_ciudades ORDER BY nombre;
	ELSE
		SELECT * FROM cat_ciudades WHERE estado=P_estado ORDER BY nombre;
	END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPQ_cat_estados`()
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPQ_cat_puestos`(IN P_id INT, IN P_order VARCHAR(50))
BEGIN
	SET @sqlQuery = "SELECT * FROM cat_puestos";
...
-- Dump completed on 2016-05-31  2:14:25
