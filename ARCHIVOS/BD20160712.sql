...
INSERT INTO `cuentasbancarias` VALUES (1,'Cta1','Ahorro',4,'123456007','123456789000',5000.00);
...
INSERT INTO `eventos` VALUES (1,'Evento1',0,0,1,0,1,1,'2016-09-16 05:00:00','2016-09-16 05:00:00','2016-09-18 05:00:00',200,0,1,1.00,NULL,0.00,0.00,0.00,0,0,0.00,1,0,500.00,0.00),(2,'Evento2',0,0,2,0,1,1,'2016-11-20 06:00:00','2016-11-20 06:00:00','2016-11-23 06:00:00',200,0,1,1.00,NULL,0.00,0.00,0.00,0,0,0.00,1,0,500.00,0.00),(3,'Evento3',0,0,2,0,1,1,'2016-11-20 06:00:00','2016-11-20 06:00:00','2016-11-23 06:00:00',200,0,1,1.00,NULL,0.00,0.00,0.00,0,0,0.00,1,0,500.00,0.00),(4,'Evento4',0,0,2,0,1,1,'2016-11-20 06:00:00','2016-11-20 06:00:00','2016-11-23 06:00:00',200,0,1,1.00,NULL,0.00,0.00,0.00,0,0,0.00,1,0,500.00,0.00),(5,'Evento5',0,0,2,0,1,1,'2016-11-25 06:00:00','2016-11-25 06:00:00','2016-12-01 06:00:00',200,0,1,1.00,NULL,0.00,0.00,0.00,0,0,0.00,1,0,500.00,0.00);
...
CREATE TABLE `modulos` (
  ...
  `prioridad` char(2) NOT NULL DEFAULT '0',
  `orden` char(2) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
...
INSERT INTO `modulos` VALUES (1,'Cat&aacute;logos',NULL,'book','0','1'),(2,'&Aacute;reas','areas.php',NULL,'1','1'),(3,'Familias','familias.php',NULL,'1','2'),(4,'Subfamilias','subfamilias.php',NULL,'1','3'),(5,'Bancos','bancos.php',NULL,'1','4'),(6,'Cuentas bancarias','cuentasBancarias.php',NULL,'20','4'),(8,'Config',NULL,'cog','0','8'),(9,'Roles','roles.php',NULL,'8','1'),(10,'Empleados','empleados.php',NULL,'20','1'),(13,'Art&iacute;culos','articulos.php','barcode','0','4'),(14,'Externos',NULL,'group','0','3'),(15,'Clientes','clientes.php',NULL,'14','1'),(16,'Eventos','eventos.php','clipboard','0','5'),(17,'Lugares','lugares.php',NULL,'1','5'),(18,'M&eacute;todos de pago','metodosPago.php',NULL,'1','6'),(19,'Proveedores','proveedores.php',NULL,'14','2'),(20,'Administrativo',NULL,'folder-open','0','2'),(21,'Puestos','puestos.php',NULL,'20','2'),(22,'Ranking','ranking.php',NULL,'1','7'),(23,'Servicios','servicios.php','tags','0','6'),(24,'Status','status.php',NULL,'1','8'),(25,'Tipos de evento','tiposEvento.php',NULL,'1','9'),(26,'Vendedores','vendedores.php',NULL,'20','3'),(27,'M&oacute;dulos','modulos.php',NULL,'8','2');
...
INSERT INTO `rolesmodulos` VALUES (1,1,1),(2,1,2),(3,1,3),(4,1,4),(5,2,1),(6,2,2),(7,2,3),(8,2,4),(9,1,5),(10,1,6),(14,1,8),(15,1,9),(16,1,10),(19,1,13),(20,1,14),(21,1,15),(22,1,16),(23,1,17),(24,1,18),(25,1,19),(26,1,20),(27,1,21),(28,1,22),(29,1,23),(30,1,24),(31,1,25),(32,1,26),(33,1,27);
...
BEGIN
	SET @sqlQuery = CONCAT("SELECT cbs.nombre, cb.nombre AS banco, cbs.noCuenta, cbs.clabe, g.fechaSolicitud AS fechaGasto, g.monto AS gasto, c.fecha AS fechaCobro, c.monto AS cobro 
					...
					LEFT JOIN cat_bancos cb ON cb.id=cbs.banco
					RIGHT LEFT JOIN cobros c ON cbs.id=c.cuentaBancaria
					RIGHT LEFT JOIN gastos g ON cbs.id=g.cuentaBancaria 
...
BEGIN
	SET @sqlQuery = "SELECT rm.id AS id_rolModulo, m.id AS id_modulo, m.nombre AS modulo, r.id AS id_rol, r.nombre AS rol, m.url, m.claseAwesome, m.prioridad, m.orden
...
-- Dump completed on 2016-07-12 12:45:37
