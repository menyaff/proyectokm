<?php
	...
	switch($accion){
		case "select":
			...
			break;
		case "update":
			$WS = new webservice("hdnId, iClave, iNombre, iNombreComercial, iCargo, iMontoCredito, iDiasCredito, iTipoContacto, iNombreContacto, iWebContacto, iDireccionContacto, iColoniaContacto, selCiudadContacto, iCodigoPostalContacto, iTelefonoContacto, iCelularContacto, iEmailContacto, iRfcFiscal, iRazonSocialFiscal, iCalleFiscal, iColoniaFiscal, selCiudadFiscal, iPaisFiscal, iCodigoPostalFiscal, iNumeroInteriorFiscal, iNumeroExteriorFiscal, iLocalidadFiscal, selMunicipioFiscal");
