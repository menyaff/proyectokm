...
<!-- Barra Lateral -->
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="cotizacion.php"><span class="fa fa-fw fa-shopping-cart"></span> Cotización</a></li>
                    ...
                    <li><a href="javascript:;" data-toggle="collapse" data-target="#sub-menu-catalagos"><span class="fa fa-fw fa-book"></span> Catálogos<span class="fa fa-fw fa-caret-down"></span></a>
                            <ul id="sub-menu-catalagos" class="collapse">
                                ...
                                <li><a href="tiposEvento.php">Tipos de evento</a></li>
                            </ul>
                    </li>
                </ul>
            </div>
